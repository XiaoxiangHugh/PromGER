# Nair (8) came up with electron-ion interaction pseudopotentials (EIIP) value of nucleotides A, G, C, T (A: 0.1260, C: 0.1340, G: 0.0806, T:0.1335).
# The EIIP directly use the EIIP value represent the nucleotide in the DNA sequence.
# Therefore, the dimension of the EIIP descriptor is the length of the DNA sequence.
